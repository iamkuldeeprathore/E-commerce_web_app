...
import org.ecommerce.project.repository.ControllerRepository;
...
public class CategoryServiceImp implements CategoryService {
    ...
    public CategoryResponse getAllCategories(Integer  pageNumber , Integer pageSize ,String sortBy, String sortOrder) {
        ...
        Page <Category> categoryPage= controllerRepository.findAll(pageable);
    ...
    public CategoryDTO addCategory(CategoryDTO categoryDTO) {
           ...
           Category cat= controllerRepository.save(category);
    ...
    public String deleteCategory(Long id) {
        Category cat = controllerRepository.findById(id).orElseThrow(()->
                new ResourceNotFoundException("Category","CategoryId",id));

        controllerRepository.delete(cat);
    ...
    public CategoryDTO updateCategory(CategoryDTO categoryDTO, Long id) {
        Category category= modelMapper.map(categoryDTO,Category.class);
        Category cat= controllerRepository.findById(id)
                .orElseThrow(()-> new ResourceNotFoundException("Category","CategoryId",id));

        category.setCategoryId(id);
        Category savedCategory= controllerRepository.save(category);
    ...
    public Optional<Category> findByCategoryName(String categoryName) {
        Optional<Category> x = controllerRepository.findByCategoryName(categoryName);
        return x;
    }
}
